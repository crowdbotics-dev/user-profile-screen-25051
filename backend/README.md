...
## Project Structure
    ...
    ├── user_profile_screen_25051  # Django project configurations
...
1. Clone this repo and `cd user_profile_screen_25051`
...
2. Clone this repo and `cd user_profile_screen_25051`
